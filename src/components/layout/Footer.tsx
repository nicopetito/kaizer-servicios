...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#F6F9FC] border-t border-[#E4EBF5] mt-auto">
      <Container className="py-12 lg:py-16">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-[#7A95B0] text-sm leading-relaxed max-w-xs">
          ...
          {/* Col 2 — Navegación */}
          <div>
            <h3 className="text-[#0A0F1E] text-xs font-semibold uppercase tracking-widest mb-4">
              Navegación
            </h3>
            <ul className="flex flex-col gap-2.5">
              {NAV_LINKS.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-[#7A95B0] text-sm hover:text-[#00C0DE] transition-colors duration-150"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              <li className="flex items-start gap-2 text-[#7A95B0] text-sm">
                <span className="mt-0.5 text-[#00C0DE]"><IconMapPin /></span>
                <span>{CONTACT_INFO.city}</span>
              </li>
              <li className="flex items-center gap-2 text-[#7A95B0] text-sm">
                <span className="text-[#00C0DE]"><IconPhone /></span>
                <a href={`tel:${CONTACT_INFO.phone.replace(/\s/g, "")}`} className="hover:text-[#0A0F1E] transition-colors duration-150">
                  {CONTACT_INFO.phone}
                </a>
              </li>
              <li className="flex items-center gap-2 text-[#7A95B0] text-sm">
                <span className="text-[#00C0DE]"><IconMail /></span>
                <a href={`mailto:${CONTACT_INFO.email}`} className="hover:text-[#0A0F1E] transition-colors duration-150 break-all">
                  {CONTACT_INFO.email}
                </a>
              </li>
            </ul>
            ...
            <div className="flex items-center gap-2.5 flex-wrap">
              {SOCIAL_LINKS.map((social) => (
                <a
                  ...
                  className="flex items-center justify-center w-9 h-9 rounded-full bg-white border border-[#E4EBF5] text-[#7A95B0] hover:bg-[#00C0DE] hover:text-white hover:border-[#00C0DE] hover:scale-105 transition-all duration-200 shadow-[0_1px_3px_rgba(10,15,30,0.06)]"
                >
        ...
        {/* Línea inferior */}
        <div className="mt-10 pt-6 border-t border-[#E4EBF5] flex flex-col sm:flex-row items-center justify-between gap-3 text-[#7A95B0] text-xs">
